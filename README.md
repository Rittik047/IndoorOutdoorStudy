...
* **Pierra IPS7100**: Measures PM density (micrograms/m<sup>3</sup>) and particle count (counts/m<sup>3</sup>) for 7 size bins: PM<sub>0.1</sub>, PM<sub>0.3</sub>, PM0.5, PM1, PM2.5, PM5, and PM10.
